...
export const metadata: Metadata = {
  title: "Balens Yoga Teacher Insurance | Professional Cover",
  description: "Balens insurance for yoga instructors. Specialist fitness professional liability insurance.",
  alternates: {
  ...
  return (
    <div className="min-h-screen py-16 px-4">
      <article className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-white mb-6">Balens Yoga Teacher Insurance</h1>
