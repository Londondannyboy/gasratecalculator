...
export const metadata: Metadata = {
  title: "Trainee Yoga Teacher Insurance | Student Coverage",
  description: "Insurance for trainee yoga teachers and students completing certification. Affordable trainee coverage.",
  alternates: {
  ...
  return (
    <div className="min-h-screen py-16 px-4">
      <article className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-white mb-6">Trainee Yoga Teacher Insurance</h1>
        <p className="text-lg text-slate-400 mb-8">Insurance for trainees completing yoga teacher training. Many programs require professional indemnity insurance.</p>
